...
stronger condition than ordinary real differentiability.
\end{ObjL}
...
\xref{8.3.4} gives a derivative with an oscillatory discontinuity at $0$.
\end{ObjL}
...
\]
then the Taylor polynomials converge back to $f$ near $\alpha$.
\end{ObjL}
